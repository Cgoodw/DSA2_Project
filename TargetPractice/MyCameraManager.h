...
Date: 2015/10
----------------------------------------------*/
#ifndef __MyCameraManagerSINGLETON_H_
#define __MyCameraManagerSINGLETON_H_
...
namespace BasicX
{
	...
	{
		static MyCameraManager* m_pInstance; // Singleton pointer
		std::vector<MyCamera*> m_lCamera; //Camera list holder
	...
	public:
		...
		OUTPUT:
		*/
		static MyCameraManager* GetInstance();
		/*
		...
		*/
		MyCamera* GetCamera(int a_nIndex = -1);
		/*
	...
	private:
		...
		OUTPUT:
		*/
		MyCameraManager(void);
		/*
		USAGE: Copy Constructor
		ARGUMENTS:
		OUTPUT:
		*/
		MyCameraManager(MyCameraManager const& other);
		/*
		USAGE: Copy Assignment Operator
		ARGUMENTS:
		OUTPUT:
		*/
		MyCameraManager& operator=(MyCameraManager const& other);
		/*
		USAGE: Destructor
		ARGUMENTS: ---
		OUTPUT: ---
...
#endif //__MyCameraManagerSINGLETON_H_